      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            Best Website & Application Development Company<br/>
            Rooting Your Business With Us
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              We provide perfect solutions for your Business.
               We listen, do research and make plans together with
                our clients to reach clients goals, 
                whether it be developing a website, 
                a software or a product or a mobile application.
            </p>
